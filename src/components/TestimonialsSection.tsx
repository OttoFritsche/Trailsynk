...
const TestimonialsSection: React.FC = () => {
  return <section id="testimonials" className="bg-white py-[50px]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => <div key={index} className="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-all border border-gray-100 flex flex-col animate-on-scroll" style={{
